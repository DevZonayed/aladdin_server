...
export declare const STRATEGY_NOT_ALLOWD_TO_TRADE_ASSET = " strategy is not allowed to trade this asset";
export declare const INVALID_BINANCE_CREDENTIALS = "Invalid Binance Credentials";
export declare const ORDER_CREATE_SUCCESS = "Order create success!";
export declare const ORDER_CREATE_FAILED = "Order create FAILED!";
export declare const NO_SUBSCRIBER_FOUND = "No Subscriber Found";
export declare const STRATEGY_BOT_CREATED_SUCCESSFULLY = "Strategy Bot Created Successfully";
export declare const STRATEGY_BOT_CREATED_FAILED = "Strategy Bot Created Failed";
export declare const STRATEGY_BOT_NOT_FOUND = "Strategy Bot Not Found";
