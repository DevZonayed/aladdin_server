export function notificationExitingTemplate(message) {
    const template = `
        <!DOCTYPE html>
        <html>
        <head>
...
export function notificationWarningTemplate(message) {
    const template = `
        <!DOCTYPE html>
        <html>
        <head>
...
export function notificationErrorTemplate(message) {
    const template = `
        <!DOCTYPE html>
        <html>
        <head>
...
export function notificationSuccessTemplate(message) {
    const template = `
        <!DOCTYPE html>
        <html>
        <head>
...
export function notificationInfoTemplate(message) {
    const template = `
        <!DOCTYPE html>
        <html>
        <head>
